        ...
        <Tabs>
            ...
            <TabPane label="补充信息" :disabled="pointInfo">
                <Form ref="supplementaryInfo" :label-width="100" :model="extraInfo">
                    ...
                    <FormItem label="回访周期" prop="visitCycle">
...
associate, tagAdd, transfer, changeStatus, getCustomerByCreditCode, tagList, associateList } from '_s/customer'
export default {
    data() {
        return {
